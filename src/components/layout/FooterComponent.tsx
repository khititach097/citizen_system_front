...
const FooterComponent = () => {
  return (
    <div className="bg-[#0F0F0F]">
      <Footer
        className=" text-white py-20 z-10000 container mx-auto bg-[inherit] !px-0"
        style={{
          zIndex: 10000,
        }}
      >
        <Row className="">
          ...
          <Col span={8} className="flex flex-col gap-8">
            ...
            <span className="leading-8">
              Bedrock Analytics Co., Ltd. 304 Vanit Place Aree (Building A),
              25th Floor, Unit 2501, Phaholyothin Road, Samsen Nai, Phaya Thai,
              Bangkok 10400
            </span>
          </Col>
        </Row>
